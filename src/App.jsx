...
const ArchitectureMonitor = ({ logs }) => {
  ...
  return (
    <div className={`fixed bottom-4 right-4 bg-zinc-950/95 backdrop-blur border border-zinc-800 rounded-lg shadow-2xl overflow-hidden text-[10px] font-mono z-[100] transition-all hover:opacity-100 opacity-80 pointer-events-none ${isMinimized ? 'w-12 h-12' : 'w-80'}`}>
