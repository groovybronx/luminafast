...
- **Performance UI** : Trop d'événements de progression peuvent laguer l'UI.
  - _Mitigation_ : Debounce/Throttle des mises à jour de state (déjà géré partiellement côté Rust, à vérifier côté TS).
- **Grands dossiers** : Scan de 10k+ fichiers.
  - _Mitigation_ : Pagination ou virtualisation de la liste de pré-import si affichée.
