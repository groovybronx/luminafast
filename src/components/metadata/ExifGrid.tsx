...
export const ExifGrid = ({ exif }: ExifGridProps) => (
  <div className="grid grid-cols-2 gap-y-2 text-[10px] font-mono text-zinc-500 uppercase tracking-tighter">
    ...
    <div className="flex items-center gap-2 px-2 py-1 bg-zinc-900/50 rounded border border-zinc-800/50 justify-end truncate">
      <MapPin size={12} className="text-zinc-600" />{' '}
      {exif.gpsLat != null ? exif.gpsLat.toFixed(4) : '--'}
    </div>
