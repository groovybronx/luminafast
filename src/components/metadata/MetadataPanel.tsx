  ...
  <div className="p-5 space-y-10 animate-in fade-in duration-500">
    ...
    <div className="space-y-4 pt-4 border-t border-zinc-800">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {activeImg.state.tags.map((t) => (
          <span
            key={t}
            className="bg-zinc-800/80 text-zinc-400 px-2.5 py-1 rounded-md text-[10px] border border-zinc-700 hover:border-blue-500 cursor-pointer transition-all flex items-center gap-1.5 group"
          >
    ...
    <div className="p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl space-y-2 shadow-2xl">
      ...
      <p className="text-[10px] text-zinc-500 leading-relaxed font-medium">
        L'asset binaire est stocké localement. Les métadonnées sont prêtes pour la synchronisation
        CouchDB via PouchDB. Conflits détectés : <span className="text-emerald-500">0</span>.
      </p>
    </div>
  </div>
);
